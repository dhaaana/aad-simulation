...
class CourseViewHolder(view: View): RecyclerView.ViewHolder(view) {
    ...
    fun bind(course: Course, clickListener: (Course) -> Unit) {
        ...
        val courseNameTextView = itemView.findViewById<TextView>(R.id.tv_course)
        val lecturerTextView = itemView.findViewById<TextView>(R.id.tv_lecturer)
        val timeTextView = itemView.findViewById<TextView>(R.id.tv_time)
