...
class HabitAdapter(
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            when (RandomHabitAdapter.PageType.valueOf(habit.priorityLevel.uppercase())) {
                RandomHabitAdapter.PageType.HIGH -> ivPriority.setImageResource(R.drawable.ic_priority_high)
                RandomHabitAdapter.PageType.MEDIUM -> ivPriority.setImageResource(R.drawable.ic_priority_medium)
                RandomHabitAdapter.PageType.LOW -> ivPriority.setImageResource(R.drawable.ic_priority_low)
            }
        }
